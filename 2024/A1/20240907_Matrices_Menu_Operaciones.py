...
def miMatriz_Diagonal_Mejorada(pMartiz):
    for i in range(0,3):
        print(f"Valor {i},{i}:{pMartiz[i][i]}")
...
def miMatriz_EncimaContraDiagonal(pMartiz):
    for i in range(0,3):
        for j in range(0,3):
            if i+j<=2:
                print(f"Valor {i},{j}:{pMartiz[i][j]}")
...
def miMenu():
    ...
    print("8. Mostrar Encima Contra Diagonal")
    print("9. Salir")
...
def mimain():
    ...
    while True:
        ...
        if opcion == 1:
            ...
            miMatriz_Diagonal_Mejorada(miMatrix)
        elif opcion == 5:
            miMatriz_Muestra(miMatrix)
            ...
            miMatriz_EncimaContraDiagonal(miMatrix)
        elif opcion == 9:
            break
        else:
